...
public class GrievanceFragment extends AicteFragment {
    ...
    public static GrievanceFragment newInstance() {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Picasso.with(getContext()).load(R.drawable.grievance).into(ivPic);
        tvInfo.setText(getResources().getString(R.string.full_info_grievance));
    }
}
